  ...
  return (
    <div>
      ...
      <div className="flex-1 bg-zinc-900 min-h-screen w-full text-zinc-300 items-center justify-center py-10 px-80 space-y-6 text-xl">
        ...
        <img
          src="/apt manual.gif"
          className="m-auto rounded-xl border-2 border-zinc-700 border-solid"></img>
        ...
        <p className="text-justify indent-10">
          ...
          easily double – the PRDO is used country-wide for all of its service
          providers and it often gets flooded with requests, significantly
          increasing its response time.
        </p>
        <p className="text-justify indent-10">
        ...
        <p className="text-justify indent-10">
          ...
          seconds, and the bot is less affected when the portal is overloaded,
          not taking more than 40 seconds for each entry in this condition.
        </p>
        ...
        <p className="text-justify indent-10">
          ...
          Without taking tests and config files into account, 31 scripts were
          used in this project, 23 of them being ‘.psm1’, 7 ‘.ps1’ and one
          python.
        </p>
      </div>
    </div>
